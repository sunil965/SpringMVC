...
public class ControllerClass {
	...
	public @ResponseBody String verifyMail(HttpServletRequest request){
		
		String email = request.getParameter("email");
		System.out.println("Inside email varifier.."+email);
...
*/
		if (res.hasErrors()) {
			...
			boolean result = userServiceImpl.checkExistingEmail(registrationModel.getEmail());
			if (result == true)
			{
